...
function b3m_custom_login_logo() {
    ...
    h1 a { background-image:url('.get_stylesheet_directory_uri().'/ymlogo.png) !important; background-size: 311px 100px !important;height: 100px !important; width: 311px !important; margin-bottom: 0 !important; padding-bottom: 0 !important; }
    .login form { margin-top: 10px !important; }

	a.ds-kaixin{display:none;}
        a.ds-renren{display:none;}
        a.ds-netease{display:none;}
        a.ds-sohu{display:none;}
	p.forgetmenot {display:none;}
	#nav {display: none;}

div#ds-login:before {content: "社交账号登陆：";}
...
//is not effective
//	remove_menu_page( 'admin.php?page=wpjam-qiniutek' );
}

//http://blog.wpjam.com/m/remove-unnecessary-code-from-wp_head/
